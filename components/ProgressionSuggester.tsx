...
import { SuggestedChord, Instrument } from '../types';
...
const ProgressionSuggester: React.FC<ProgressionSuggesterProps> = ({ isOpen, onClose, isLoading, suggestion, error, onAddChords, instrument, isQuietMode = false }) => {
